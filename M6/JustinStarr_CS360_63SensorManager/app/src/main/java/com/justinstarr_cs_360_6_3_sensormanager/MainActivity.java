package com.justinstarr_cs_360_6_3_sensormanager;
...
public class MainActivity extends AppCompatActivity {
    ...
    SensorEventListener listener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            sensorData.setText("x: " + sensor_data[0] + "\ny: " + sensor_data[1] + "\nz: " + sensor_data[2]);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (myList.size()!= 0) {
            ...
            Toast.makeText(getBaseContext(), "Accelerometer not detected", Toast.LENGTH_LONG).show();
        }
    }
